...
var log = helper_1.helper.logger.get('InteractableComponent');
var InteractableComponent = /** @class */ (function (_super) {
    __extends(InteractableComponent, _super);
    function InteractableComponent(ef) {
        var _this = _super.call(this, ef) || this;
        _this.ef = ef;
        return _this;
    }
    // get
    InteractableComponent.prototype.getText = function () {
    ...
    // actions
    InteractableComponent.prototype.click = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
